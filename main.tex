...
\newcommand{\monthyear}{Φεβρουάριος 2024}
...
\newcommand{\cosupname}{Ευθύμιος Χούσος}
\newcommand{\cosuptitle}{Ομότιμος Καθηγητής}
...
\input{chapters/iot_and_cyberphysical/main}
\input{chapters/virtualization/main}
\input{chapters/kubernetes/main}
\input{chapters/case_study/main}
\input{chapters/architecture/main}
\input{chapters/apache_kafka/main}
\input{chapters/kubernetes_utilization/main}
\input{chapters/future_work/main}
